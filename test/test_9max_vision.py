#!/usr/bin/env python3
# ============================================================
# TEST SIMULAZIONE 9-MAX: Vision parsing su screenshot 9-max reali
# ============================================================
# Prende un file screenshot 9-max, invia alla Vision (LM Studio)
# e verifica l'estrazione dei player, incluse le carte, Hero e
# lo stato 'active' (attivo vs semi-trasparente).
# ============================================================
...
# Cartella screenshot 9-max
SHOTS_DIR = os.path.join(
    _parent,
    "..", "modalità-web-9max-4colori"
)

def main():
    print("=" * 60)
    print("TEST SIMULAZIONE STATICA 9-MAX (Vision + Stato Active)")
    print("=" * 60)

    if not os.path.exists(SHOTS_DIR):
        print(f"ERRORE: Cartella non trovata: {SHOTS_DIR}")
        print(f"Cerca screenshot nella cartella del progetto")
        sys.exit(1)
    ...
    # Inizializza SeeModule con formato 9max
